  ...
  return (
    <div className="p-4 h-full flex flex-col">
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="font-semibold text-foreground">Top Hirings</h3>
      </div>

      {/* Tabs */}
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col">
        <TabsList className="w-full justify-start mb-4 h-auto p-1 bg-secondary/50">
          <TabsTrigger 
            value="today" 
            className="flex-1 text-xs data-[state=active]:bg-card"
          >
            Today
          </TabsTrigger>
          <TabsTrigger 
