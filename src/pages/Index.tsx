         ...
         <div className="container max-w-6xl mx-auto px-4">
           <div className="text-center mb-12">
             ...
             <p className="text-muted-foreground max-w-xl mx-auto">
               Stop juggling spreadsheets. JobTracker keeps everything organized.
             </p>
           </div>
           ...
           <div className="flex flex-col lg:flex-row items-center gap-12">
             <div className="flex-1">
               ...
               <p className="text-muted-foreground mb-6">
                 JobTracker makes it easy to find, apply, and track opportunities 
       ...
       <section className="py-16 bg-primary">
         <div className="container max-w-6xl mx-auto px-4 text-center">
           ...
           <p className="text-primary-foreground/80 mb-8 max-w-xl mx-auto">
             Join thousands of job seekers who use JobTracker to find and land their dream jobs.
           </p>
           <Link to="/dashboard">
             <Button 
               size="lg" 
